...
def saveResult(save_path, npyfile, flag_multi_class=False, num_class=2):
    for i, item in enumerate(npyfile):
        ...
        img.save(os.path.join(save_path, "%d_predict.png" % i))
...
data_gen_args = dict(rotation_range=0.2,
                     ...
                     fill_mode='nearest')
myGene = trainGenerator(2, source_images, 'image', 'label', data_gen_args, save_to_dir=None)
model = unet()
model_checkpoint = ModelCheckpoint('unet_bm.hdf5', monitor='loss', verbose=1, save_best_only=True)
